...
module.exports = function(app, passport) {
  app.post('/comment/pull/:commentType/:hostId', authorization.appToken, comment.getComment);
  app.post('/comment/push/:commentType/:hostId', authorization.appToken, comment.canPublishComment, comment.setComment);
